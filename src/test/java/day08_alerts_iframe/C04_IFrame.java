...
public class C04_IFrame {
   ...
   @Test
    public void test01() throws InterruptedException {
      ...
      WebElement linYaziElementi=driver.findElement(By.linkText("Elemental Selenium"));
      Assert.assertTrue(linYaziElementi.isDisplayed());
      System.out.println(linYaziElementi.getText());
