...
public class C05_FileUpload extends TestBase {
    ...
    public void test01() throws InterruptedException {
      ...
      //  Yuklemek istediginiz dosyayi secelim.
        ...
        /*
        bu islemi sellenium ile yapma imkanimiz yok cunku web tabanli bir uygulama degil
        ...
        //biz masaustumuzdeki text.txt dosyasini yollayalim

        String farkliKisim=System.getProperty("user.home");
        String ortakKisim="\\Desktop\\text.txt";
        String yuklenecekDosya=farkliKisim+ortakKisim;

        //3. adim sendKeys ile dosya yolunu secme butonunu yollayalım
